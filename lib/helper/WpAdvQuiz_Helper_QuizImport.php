...
class WpAdvQuiz_Helper_QuizImport
{
     ...
     * @return WpAdvQuiz_Helper_QuizImporterInterface|null
     */
    public function factory($name, $type, $resource)
    {
        ...
        return $impoter instanceof WpAdvQuiz_Helper_QuizImporterInterface ? $impoter : null;
    }
    ...
    protected function runHooks()
    {
        if (!self::$booted) {
            ...
            do_action('wpAdvQuiz_quizImport_boot', $this);
        }
    }
    ...
    {
        return WpAdvQuiz_Helper_XmlQuizImporter::factory($resource);
    }
